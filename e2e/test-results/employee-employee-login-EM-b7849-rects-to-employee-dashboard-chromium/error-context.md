...
- Name: employee\employee-login.spec.ts >> EMP001 - Unified Login Page & Automatic Role Routing >> EMP001-01 Valid employee login auto-redirects to employee dashboard
- Location: tests\employee\employee-login.spec.ts:14:7
...
- textbox "Enter your email address": employee@aseuro.com
