...
- Name: manager\manager-workflow.spec.ts >> MGR001 — Manager Role Full Workflow >> MGR001-02 Manager Views Assigned Direct Reports
- Location: tests\manager\manager-workflow.spec.ts:16:7
...
Call log:
  - waiting for locator('a[href="/manager/employees"]')
