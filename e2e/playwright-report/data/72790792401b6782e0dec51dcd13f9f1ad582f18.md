...
- Name: employee\employee-login.spec.ts >> EMP001 - Unified Login Page & Automatic Role Routing >> EMP001-08 Automatic role-based routing: Manager credentials navigate directly to Manager Dashboard
- Location: tests\employee\employee-login.spec.ts:139:7
...
- textbox "Enter your email address": manager@aseuro.com
