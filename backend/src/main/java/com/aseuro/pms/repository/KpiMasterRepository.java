...
public interface KpiMasterRepository extends JpaRepository<KpiMaster, Long> {
    ...
    List<KpiMaster> findByDesignationIgnoreCaseAndKpiCategoryAndStatus(String designation, String kpiCategory, String status);
    List<KpiMaster> findByKpiCategoryAndStatus(String kpiCategory, String status);
