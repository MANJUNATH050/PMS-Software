...
public class DashboardController {
        ...
        public ResponseEntity<Map<String, Object>> hrDashboard(@AuthenticationPrincipal User principal) {
                ...
                return ResponseEntity.ok(Map.of(
                                ...
                                "message",
                                "Login verified from the database. Use this workspace to provision managers and employees.",
        ...
        public ResponseEntity<Map<String, Object>> managerDashboard(@AuthenticationPrincipal User principal) {
                ...
                List<Employee> assignedEmployees = manager != null ? employeeRepository.findByManagerId(manager.getId())
                                : List.of();
                ...
                return ResponseEntity.ok(Map.of(
                                ...
                                "message",
                                "Login verified from the database. Assigned team members and review cycles appear here.",
        ...
        public ResponseEntity<Map<String, Object>> employeeDashboard(@AuthenticationPrincipal User principal) {
                ...
                return ResponseEntity.ok(Map.of(
                                ...
                                "message",
                                "Login verified from the database. Complete your monthly self-assessment and view ratings.",
